...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{url('kepsek/pegawai/'.$idPegawai)}}" method="POST">
                @method('patch')
                @csrf
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tmpLahir" name="tmpLahir" value="{{$pegawai->tmpLahir}}">
                                @error('tmpLahir')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tglLahir" name="tglLahir" value="{{$pegawai->tglLahir}}">
                                @error('tglLahir')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
