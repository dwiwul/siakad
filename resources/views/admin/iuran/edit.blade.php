...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h1 class="h3 mb-4 text-gray-800">Edit Data Pembayaran Iuran</h1>
        </div>
        <div class="card-body">
            <form action="{{ url('admin/iuran/'.$id)}}" method="POST">
        @csrf
        @method('patch')
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{$iuran->tgl}}" class="form-control" id="tgl" name="tgl">
                        @error('tgl')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$iuran->jenisBayar}}"class="form-control" id="jenisBayar" name="jenisBayar">
                        @error('jenisBayar')
                            <small class="text-danger">{{ $message}}</small>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="jumlahBayar">Jumlah iuran</label>
                        <input type="text" value="{{$iuran->jumlahBayar}}"class="form-control" id="jumlahBayar" name="jumlahBayar">
                        @error('jumlahBayar')
                            <small class="text-danger">{{ $message}}</small>
                        @enderror
                    </div>
        ...
        <a href="{{url('admin/iuran/index')}}" class="btn btn-secondary btn-sm">Kembali</a>
    </form>
        </div>
    </div>
@endsection
